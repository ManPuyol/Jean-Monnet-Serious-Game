...
export default async function SidebarSubjects({activeSubjectId}: {activeSubjectId: string}) {
  const subjects: Subject[] = await allSubjects();
  return (
    <div className="f lex-1 md:border-r pt-2">
      <div className="px-3 py-2">
        ...
        <SubjectNavigation subjects={subjects} path='teach' activeSubjectId={activeSubjectId} />
      </div>
    </div>
  );
}